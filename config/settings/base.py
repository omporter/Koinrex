"""
Base settings for Koinrex project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (koinrex/config/settings/base.py - 3 = koinrex/)
APPS_DIR = ROOT_DIR.path('koinrex')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'koinrex.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///koinrex'),
}
